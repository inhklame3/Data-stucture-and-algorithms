...
class Program
{
    static void Main(string[] args)
    {
        ...
        string[] ms = { "1. Xem danh sách sinh viên", "2. Thêm sinh viên mới",
                ...
                "6. Cập nhật danh sách vào file", 
                "7. Cho biết điểm bình quân của tất cả sinh viên",
                "8. Xuất lên màn hình ds sinh viên học lại (có DiemTB < 5)","0. Thoát" };
        ...
        do
        {
            ...
            switch (chon)
            {
                ...
                case 4:
                    {
                        Console.Write(" Nhập mã sinh viên cần sửa điểm : "); string ma = Console.ReadLine();
                        int vt = ds.FindSV(ma);
                        if (vt == -1)
                            Console.WriteLine("   Không có sinh viên này");
                        else
    ...
    static void ViewDSSV(DSSV ds)
    {
        ...
        Console.WriteLine("  5. Xuất lên màn hình ds sinh viên học chuyên nghành cn ");      
        Console.Write("       Chọn : ");
