...
namespace Buoi01
{
    internal class DSSV
    {
        ...
        public void FileToList(string filePath)
        {
            ...
            {      // Đọc các dòng trong file  array lines
                ...
                for (int i = 0; i < lines.Length; i++)
                {
                    ...
                    string ms = s[0]; string ho = s[1]; string t = s[2]; string ns = s[3];
        ...
        // Sắp xếp danh sách với tham số k = 1.theo mã SV, 2.theo tên, 3.theo nghành, 4. Điểm TB, 5.Chuyên ngành cn
        ...
        public void DsChuyenNganh(string cn)
        {
            for (int i = 0; i < lst.Length - 1; i++)
